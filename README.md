...
Contribuições são muito bem-vindas! Sinta-se à vontade para abrir Issues para reportar bugs ou sugerir novas funcionalidades. Para mais detalhes, veja nosso [Guia de Contribuição](https://github.com/box4dev/api-gerador-boleto?tab=contributing-ov-file#readme).

## Licença

Distribuído sob a licença MIT. Veja [Licença](https://github.com/box4dev/api-gerador-boleto?tab=MIT-1-ov-file#readme) para mais informações.

## Segurança

Para reportar vulnerabilidades de segurança, consulte nossa [Política de Segurança](https://github.com/box4dev/api-gerador-boleto?tab=security-ov-file#readme).
