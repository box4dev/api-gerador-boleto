...
Para reportar uma falha de segurança que afete nosso código ou sua implementação, por favor, envie um e-mail com os detalhes para:
**[contact@box4.dev]**
...
Agradecemos sua ajuda para manter o `api-gerador-boleto` seguro para todos!